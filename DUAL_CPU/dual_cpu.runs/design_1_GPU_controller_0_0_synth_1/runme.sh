...
HD_PWD='C:/Users/khali/ENSC_452_git/ENSC_452/DUAL_CPU/dual_cpu.runs/design_1_GPU_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_GPU_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_GPU_controller_0_0.tcl
